...
import com.archi4zlo.shoppinglist.adapters.ImageAdapter
import com.archi4zlo.shoppinglist.getOrAwaitValue
import com.archi4zlo.shoppinglist.launchFragmentInHiltContainer
import com.archi4zlo.shoppinglist.repositories.FakeShoppingRepositoryTestAndroid
...
class ImagePickFragmentTest {
    ...
    fun clickImage_popBackStackAndSetImageUrl() {
        ...
        val imageUrl = "TEST"
        val testViewModel = ShoppingViewModel(FakeShoppingRepositoryTestAndroid())
